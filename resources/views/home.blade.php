            ...
            <div id="slideshow" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        ...
                        <img src="{{ asset('images/image1.png') }}" class="d-block mx-auto" alt="Sinh viên tin tưởng">
                    </div>
                    <div class="carousel-item">
                        <h3>Bắt đầu hành trình tài chính của bạn</h3>
                        <img src="{{ asset('images/image2.png') }}" class="d-block mx-auto" alt="Hành trình tài chính">
                    </div>
                </div>
